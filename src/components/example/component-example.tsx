...
import { Example, ExampleWrapper } from "@/components/example/example.tsx";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                <DropdownMenuGroup>
                  ...
                  <DropdownMenuCheckboxItem checked={notifications.email} onCheckedChange={checkEmail}>
                    <HugeiconsIcon icon={EyeIcon} strokeWidth={2} />
                    Show Sidebar
                  </DropdownMenuCheckboxItem>
                  <DropdownMenuCheckboxItem checked={notifications.sms} onCheckedChange={checkSMS}>
                            ...
                            <DropdownMenuPortal>
                              <DropdownMenuSubContent>
                                <DropdownMenuGroup>
                                  ...
                                  <DropdownMenuCheckboxItem checked={notifications.push} onCheckedChange={checkPush}>
                                    <HugeiconsIcon icon={NotificationIcon} strokeWidth={2} />
                                    Push Notifications
                                  </DropdownMenuCheckboxItem>
                                  <DropdownMenuCheckboxItem checked={notifications.email} onCheckedChange={checkEmail}>
